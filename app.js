...
function dialogoGuardarArchivo(file, filename, compartible) {
    return new Promise(resolve => {
        ...
        ayuda.textContent = compartible
            ? 'Tocá Guardar en Archivos y elegí la carpeta.'
            : 'Safari no deja guardar este archivo desde acá: se abre en una pestaña y lo guardás con el botón Compartir de Safari.';
        ...
        // La hoja de Compartir es la única vía que guarda de verdad en iPad, así
        // que va primera cuando está disponible. Disparada desde el toque,
        // conserva el gesto que iOS exige.
        if (compartible) {
            const btnCompartir = document.createElement('button');
            btnCompartir.type = 'button';
            btnCompartir.textContent = 'Guardar en Archivos';
            btnCompartir.style.cssText = estiloBoton + PRIMARIO;
                ...
                navigator.share({ files: [compartible], title: filename })
                    ...
                    .catch(err => {
                        ...
                        ayuda.textContent = 'No se pudo compartir: ' +
                            ((err && err.message) || err) + '. Probá con Abrir en una pestaña.';
        ...
        // Plan C: un blob: con download. En iPad no baja el archivo — Safari
        // navega y lo muestra —, pero desde ahí se puede usar su botón
        // Compartir. Por eso queda de segundo y con el nombre que corresponde.
        const enlace = document.createElement('a');
        enlace.href = url;
        enlace.download = filename;
        enlace.rel = 'noopener';
        enlace.textContent = compartible ? 'Abrir en una pestaña' : 'Abrir el archivo';
        enlace.style.cssText = estiloBoton + (compartible ? SECUNDARIO : PRIMARIO);
